...
export default function PatitasYCorazones() {
  ...
  return (
    <section>
      ...
      <p>
        Patitas & Corazones es una aplicación web construida con ASP.NET Core MVC
        para gestionar publicaciones y usuarios relacionados con mascotas.
        Desarrollada como proyecto de práctica, implementa autenticación,
        operaciones CRUD y acceso a base de datos mediante Entity Framework Core.
      </p>

      <p>
        <strong>Funciones principales:</strong> gestión de usuarios y publicaciones
        sobre mascotas, autenticación con cookies, vistas Razor y persistencia en SQL Server.
      </p>
      ...
      <div className="card code-card" style={{ marginTop: 20 }}>
        ...
        <div className="code-card-body">
          <h3>Código fuente</h3>
          <p>Repositorio del proyecto <strong>Patitas & Corazones</strong> en GitHub.</p>
        </div>
